...
export function CreateLeagueDialog({ children }: {
    children?: ReactNode;
} = {}) {
    ...
    return (<Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        ...
        <div className="
            space-y-4
          ">
          <Input placeholder={t("league.name")} value={name} onChange={(e) => setName(e.target.value)}/>

          <Textarea placeholder={t("league.descriptionLabel")} value={description} onChange={(e) => setDescription(e.target.value)}/>
          ...
          <Select value={joinPolicy} onValueChange={(value) => setJoinPolicy(value as "open" | "request" | "invite_only")}>
            <SelectTrigger>
