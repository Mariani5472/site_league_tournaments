...
export function LobbyActions({
    ...
    return (
      ...
      "
        >
            {!currentPlayer && (
                <Button disabled={!isWaiting || isLoading} onClick={join}>
                    {t("lobby.join")}
                </Button>
            )}
            ...
            {currentPlayer && (
                <>
                    <Button
                        ...
                        onClick={currentPlayer.isReady ? unready : ready}
                    >
            ...
            {canManage && isWaiting && (
                <Button variant="destructive" disabled={isLoading} onClick={deleteLobby}>
                    {t("lobby.cancel")}
                </Button>
            )}
        </div>
