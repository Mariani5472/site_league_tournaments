...
| A23 | RESOLVIDO | PORTFOLIO | Transformar README em vitrine verificável | Diferenciais técnicos estavam dispersos e sem visual | Recrutador não percebia rapidamente a profundidade | Abertura executiva, badges CI, screenshot real, fluxo e diagrama curto | Links e badges apontam para o repositório; setup foi preservado; ausência de demo pública está explícita |
