  ...
  return (
    <div className="space-y-8 sm:space-y-10">
      ...
      <section className="space-y-4">
        ...
        {myLeaguesError ? <div className="rounded-xl border border-destructive/30 bg-destructive/5 p-6 text-destructive">Could not load your leagues.</div> : myLeagues.length === 0 ? (
          <div
            className="
              rounded-xl
              border
      ...
      <section className="space-y-4">
        ...
        {discoverLeaguesError ? <div className="rounded-xl border border-destructive/30 bg-destructive/5 p-6 text-destructive">Could not load public leagues.</div> : discoverLeagues.length === 0 ? (
          <div
            className="
              rounded-xl
              border
